...
public class MViewGroup3 extends ViewGroup {
    ...
    public MViewGroup3(Context context) {
        super(context);
    }

    public MViewGroup3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public MViewGroup3(Context context, AttributeSet attrs, int defStyleAttr) {
